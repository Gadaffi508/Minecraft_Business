package org.example.firstplugin.minecraft;
...
public class Minecraft {
    ...
    @Inject
    Minecraft(final PluginContainer container, final Logger logger) {
    ...
    public void onConstructPlugin(final ConstructPluginEvent event) {
        ...
        this.logger.info("Constructing Minecraft");
    }
    ...
    public void onServerStarting(final StartingEngineEvent<Server> event) {
        ...
        System.out.println("Plugin is start");
    ...
    public void onRegisterCommands(final RegisterCommandEvent<Command.Parameterized> event) {
        ...
        event.register(this.container, Command.builder()
            ...
            .permission("Minecraft.command.greet")
            .executor(ctx -> {
